...
.login-box{width:410px;margin:120px auto 0 auto;text-align:center;padding:30px;background:url(http://localhost/dxwork/Public/images/mask.png);border-radius:10px;}
...
<script type="text/javascript" src="http://localhost/dxwork/Public/js/jquery-1.8.2.min.js"></script>
...
<div class="login-box">
	...
	<form method="post" action="">
		<div class="name">
			<label>管理员账号：</label>
			<input type="text" name="uname" tabindex="1" autocomplete="off" onblur="if(this.value == '')this.value='admin';" onclick="if(this.value == 'admin')this.value='';" value="admin" />
		</div>
		<div class="password">
			<label>密  码：</label>
...
<div class="bottom">©2018 PTcZn <a href="javascript:;" target="_blank">关于</a> <span>by PTcZn in ssPKU</span><img width="13" height="16" src="http://localhost/dxwork/Public/images/copy_rignt_24.png" /></div>

<div class="screenbg">
	<ul>
		<li><a href="javascript:;"><img src="http://localhost/dxwork/Public/images/cat.jpg"></a></li>
	</ul>
</div>
